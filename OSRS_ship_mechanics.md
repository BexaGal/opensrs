...
Более простые в конструкции и дешёвые реакторы применяют состав из изотопов водорода, называемый на рынке "детритий". Такие реакторы выделяют нейтроны, из-за чего требуют радиозащиты.
...
Остаток максимального выхлопа энергии раcходуется на зарядку батарей и вооружения.
...
Любой корабль способен на своих двигателях свободно взлетать с планет и станций и премещаться в бою, но с разной скоростью.
...
Основным параметром двигателя является его ускорение, выражаемое в клетках за ход (КЗХ). Так же у двигателя есть потребление энергии в ЭР.
...
### Системы десантирования
Десантники могут использовать специальные десантные капсулы для спуска на планету или для попадания в корабль. Такие капсулы стоят 20000 кредитов.
