...
## Описание
Пилоты космических кораблей - одна из самых востребованных профессий во всех государствах галактики.

Пилоты делятся на рулевых и, собственно, пилотов. Пилоты летают на малых кораблях, рулевые на крупных.
...
### Дополнительные умения: 
* Манёвр отхода - На малом корабле. После подхода к вражескому кораблю и его атаки может в тот же ход оказаться на соседней клетке, избегая ответного огня СТО. Количество использований - модификатор ловкости делённый на 2, с округлением вверх (минимум 1). Восстанавливаются после длительного отдыха.
...
### Дополнительные умения: 
* Умелое маневрирование - на крупном корабле. Гарантированно уклониться от атаки маневрированием. Количество использований - модификатор ловкости делённый на 2 с округлением вверх (минимум 1). Восстанавливается каждый длительный отдых.
