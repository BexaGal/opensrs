...
маневрировании любой член экипажа может бросить к20 + мод. ловкости рулевого со сложностью 16. При уклонении от нескольких снарядов,
...
попадание (к20 + модификатор интеллекта артиллериста) и на урон
выстрелившим орудием.

Если же снаряд не моментальный, то попадание считается иначе: к20 +
пробивная способность снаряда + (модификатор интеллекта артиллериста/2 с
