...
При лечении повышается только здоровье DSS. Для лечения базового здоровья надо провести операцию врачу, длительностью 10 минут, в ходе которой бросается проверка на Био/мед со сложностью 12. При провале операция повторяется заново.
